...
enum CMD_STATE		{ CMD_FAILED = 0, CMD_SUCCEEDED = 1, CMD_SENT = 2,	CMD_AVAILABLE = 3,	CMD_CONTINUE = 4 };
...
extern PROGMEM const char *noti_string_table[];
extern PROGMEM const char *debug_receiving_data_table[];
